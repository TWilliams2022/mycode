...
def devicereboot():
#created list of IP's  
ipAddress = ["11.11.11.11", "01.02.03.04", "10.20.30.40", "31.45.43.22.10", "23.0.10.0"]

#iterating through the list using a for loop
        for ips in ipAddress:
        print("Connecting to.. " + ips + " REBOOTING NOW! \n") #shows each ip on new line
